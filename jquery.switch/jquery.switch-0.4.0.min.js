...
{width:a.width(),height:a.height()}).data("center",{left:a.data("offset").left+a.data("dimensions").width/2,top:a.data("offset").top+a.data("dimensions").height/2});e.event.special.slide={_default:function(a,b){if(!("on"===b||"off"===b))return;e(a.target).trigger("slide"+b)}};var g=a.data("controls",{_to:function(b,c){c||(c={silent:!1});!m&&!c.silent?a.trigger("slide",[b]):m||a.trigger("slide"+b);return a},
